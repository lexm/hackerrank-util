  ...
  before(function(done) {
    mock({
      'downloads': {
        ...
        'file03.json': '{"progName":"Compute the Average","pathArray":["Linux_Shell","Bash"],"message":"Solution to Linux Shell > Bash > Compute the Average","filename":"bash-tutorials---compute-the-average.sh","allCode":"read N\nTOTAL=0\nCOUNT=$N\nwhile [ $COUNT -gt 0 ]; do\n  read INT\n  let TOTAL+=$INT\n  let COUNT-=1\ndone\nprintf \"%.3f\\n\" $(echo \" $TOTAL / $N \" | bc -l)\n"}'
      }
    });
    done();
  });
